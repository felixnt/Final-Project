				...
				<div class="col-lg-4 col-md-6 col-12">
					<div class="blog-box-inner">
						<div class="blog-img-box">
							<img class="img-fluid" src="images/{{$diet->picture}}" alt="">
						</div>
						<div class="blog-detail">
							<h4>{{$diet->title}}</h4>
							<ul>
								<li><span>Post by {{$diet->writer}}</span></li>
								<li>|</li>
								<li><span>{{$diet->created_at}}</span></li>
							</ul>
							
							<a class="btn btn-lg btn-circle btn-outline-new-white" href="/dietplan/{{$diet->slug}}">Read More</a>
						</div>
					</div>
				</div>
				@endforeach
