		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-6 col-md-4">
					<div class="card">
						<img src="/images/{{$menu->picture}}" alt="..." style="max-height: 230px" class="card-img-top">
						<div class="caption text-center">
							<h1>{{$menu->title}}</h1>
							<div class="clearfix"><a href="#" class="btn btn-success float-right">Add to Cart</a>
							<div class="float-left"><h3>Rp {{$menu->price}}</h3></div>
							</div>
						</div>
					</div>
				</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				...
				<h1><a class="btn btn-lg btn-circle btn-outline-success" href="{{url('/payment')}}">Proceed to Payment</a></h1>
				</div>
			</div>
		</div>
	</div>
