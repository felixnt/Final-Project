...
<body>
						...
						<div class="row">
							...
							<div class="col-md-12">
								...
								<div class="submit-button text-center">
									<button class="btn btn-common" id="sendMessage" type="submit">Send Message</button> <span id="loader"><img src="{{url('images/spinner.gif')}}" width="60"></span>
	...
	<script>
		...
		function checkMessage(){
			...
			if(message.length < 2){
				messageError = true;
				$('.messageError').html('<p>Message to short</p>');
			}else{
				messageError = false;
				$('.messageError').html('');
			}
