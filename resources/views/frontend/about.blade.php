			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-6 text-center">
					<div class="inner-column">
						...
						<h4>Little Story</h4>
						<p>Tuahesss adalah website yang berisikan resep-resep makanan sehat dan tips-tips untuk menajalani pola hidup sehat. Tujuan dari diciptakannya website ini adalah untuk mengajak dan membantu orang yang ingin menjalani pola hidup sehat, maka dari itu website ini dapat membantu orang yang ingin mempunyai pola hidup sehat dengan memberikan resep-resep makanan sehat dan tips-tips untuk menjalani pola hidup sehat.</p>
						<p>Resep-resep yang dapat ditemukan pada website ini ada banyak, mulai dari main course, snack, hingga beverages. Jadi para pengunjung dapat mencari resep yang lengkap untuk menemani pola hidup yang sehat.</p>
					</div>
				</div>
			</div>
		</div>
